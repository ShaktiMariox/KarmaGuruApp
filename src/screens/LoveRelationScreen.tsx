...
const LoveRelationScreen = () => {
                ...
                >
                    ...
                    <View style={[commonStyle.card,{marginTop:verticalScale(16)}]}>
                        ...
                        {[
                            ...
                            <View key={index} style={styles.doItemCard}>
  ...
  {[
    ...
    <TouchableOpacity activeOpacity={0.8} style={styles.remedyBtn}>
...
export default LoveRelationScreen
