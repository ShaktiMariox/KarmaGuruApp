...
const OnboardingScreen1 = ({ navigation }: any) => {
  ...
  return (
    <View style={styles.container}>
      {/* GIF background */}
      <FastImage
        source={require('../../assets/images/onBoarding_logo1.gif')}
      ...
      <View style={styles.overlay}>
        ...
        <Text style={styles.title}>Align with Your Karma</Text>
        <Text style={styles.desc}>See how your daily actions shape your destiny and growth.</Text>
      </View>
