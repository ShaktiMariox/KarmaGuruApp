...
const DateBirthScreen = ({ navigation }: any) => {
    ...
    const handleNext = async () => {
        if (!date) {
            ErrorHandler.alert('Please select your date of birth',);
            return;
        }
        try {
            setLoading(true);
    ...
    return (
        ...
        >
            ...
            <View style={styles.bottomContainer}>
                ...
                {show && (
                    <DateTimePicker
                        value={date || new Date()} // 👈 fallback only for picker
                        mode="date"
                        display="spinner"
...
const styles = StyleSheet.create({
  ...
  progressContainer: {
    flexDirection: 'row',
    marginTop: verticalScale(110), // adjusted from 120
    paddingHorizontal: scale(20),
    alignItems: 'center',
  },
